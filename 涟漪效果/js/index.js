...
Ripple.prototype = {
  ...
  init: function () {
    ...
    if(!this.checkImagesLoaded()){
      this.displacementImg.onload = function () { self.checkImagesLoaded() };
      this.displacementOverlayImg.onload = function () { self.checkImagesLoaded() };
    }
  },
...
ctx.drawImage(document.getElementById('mainImg'), 0, 0)
